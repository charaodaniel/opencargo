      ...
      <nav class="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 sticky top-0 z-30 relative">
        <div class="flex items-center justify-between h-16 px-4 lg:px-6">
          ...
          <div class="flex items-center space-x-3">
            ...
            <!-- Theme toggle -->
            <button onclick="Navbar.toggleTheme()" class="p-2 text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-white rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors" title="${__("theme.toggle")}">
            ...
            <div class="relative group">
              <button class="flex items-center space-x-2 p-1.5 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
                ...
                <div class="hidden md:block text-left">
                  ...
                  <p class="text-xs text-gray-500 dark:text-gray-400">${user.role === "admin" ? __("role.admin") : user.role === "company" ? __("role.company") : __("role.driver")}</p>
                </div>
              </button>
            </div>
          </div>
